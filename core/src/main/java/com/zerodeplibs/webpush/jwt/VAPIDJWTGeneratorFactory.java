 ...
 * </li>
 * <li>
 * If you have dependencies on one or more of the sub-modules(<a href="https://github.com/st-user/zerodep-web-push-java/tree/main-v1/ext-jwt">zerodep-web-push-java-ext-jwt</a>),
 ...
 * all of the implementations provided by <a href="https://github.com/st-user/zerodep-web-push-java/tree/main-v1/ext-jwt">zerodep-web-push-java-ext-jwt</a>
 * are thread-safe.
 * </p>
 *
 * @author Tomoki Sato
