 ...
 * </li>
 * <li>
 * If you use {@link #of(PrivateKeySource, PublicKeySource)} with a sub-module provided by <a href="https://github.com/st-user/zerodep-web-push-java/tree/main-v1/ext-jwt">zerodep-web-push-java-ext-jwt</a>,
 * obtained instances are thread-safe.
 * </li>
 * </ul>
 *
...
public class VAPIDKeyPairs {
     ...
     * (<a href="https://github.com/st-user/zerodep-web-push-java/tree/main-v1/ext-jwt">zerodep-web-push-java-ext-jwt</a>)
     * on your classpath.
