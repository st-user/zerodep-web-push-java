...
mvn clean test -pl zerodep-web-push-java-ext-jwt-auth0 -Dauth0.version=$AUTH0_VER -P!production-compile,jdk-8-compile
...
mvn clean test -pl zerodep-web-push-java-ext-jwt-nimbus-jose -Dnimbus.jose.version=$NIMBUS_JOSE
